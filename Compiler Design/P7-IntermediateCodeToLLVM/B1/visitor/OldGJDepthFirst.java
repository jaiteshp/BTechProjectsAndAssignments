 ...
 */
public class OldGJDepthFirst<R,A> implements GJVisitor<R,A> {
    ...
    public String searchVar1(String className1, String methName1, String v)
    {
        ...
        if(className1 == "")
        {
            ...
            throwError("Variable " + v + " in " + className1 + " not found");
            return emptyString;
        }
        return "avasaramLedu";
    }
    ...
    public R visit(ClassDeclaration n, A argu) {
        ...
        else
        {
            ...
            throwError("ERROR: Redeclaration of class " + className);
        }
        //System.out.println("classMap" + className);
        n.f2.accept(this, argu);
        methName = "";
        n.f3.accept(this, argu);
        n.f4.accept(this, argu);
    ...
    public R visit(ClassExtendsDeclaration n, A argu) {
        ...
        if(classMap.get(className) == null)
        {
            classMap.put(className, extendedClassName);
        }
        else
        {
            throwError("Type error");
            throwError("ERROR: Redeclaration/Wrong declaration of class " + className + " extends " + extendedClassName);
        }
        //classMap.put(className, extendedClassName);
        //System.out.println("classMap " + className + "~~" + extendedClassName);
        n.f4.accept(this, argu);
        methName = "";
        n.f5.accept(this, argu);
        n.f6.accept(this, argu);
    ...
    public R visit(VarDeclaration n, A argu) {
        ...
        if(methName == "")
        {
            if(varMap.get(className + "~" + varName) == null)
            {
                varMap.put(className + "~" + varName, type);
            }
            else
            {
                throwError("Type error");
                throwError("ERROR: Redeclaration of variable in " + className + " " + varName);
            }
            //System.out.println("varMap " + className + "~" + varName + "~~" + type);
        }
        else
        {
            if(varMap.get(className + "~" + methName + "~" + varName) == null)
            {
            ...
            else
            {
                ...
                throwError("Type error");
                throwError("ERROR: Redeclaration of variable in " + methName + " " + className + " " + varName);
            }
            //System.out.println("varMap " + className + "~" + methName + "~" + varName + "~~" + type);
        }
    ...
    public R visit(MethodDeclaration n, A argu) {
        R _ret=null;
        n.f0.accept(this, argu);
        methRet = (String) n.f1.accept(this, argu);
        methName = (String) n.f2.accept(this, argu);
        if(methRetMap.get(st2(className,methName)) == null)  methRetMap.put(st2(className,methName), methRet);
        n.f3.accept(this, argu);
        argNum = 0;
        n.f4.accept(this, argu);
        if(methParamMap.get(st2(className,methName)) == null)  methParamMap.put(st2(className,methName), methParam);
        else  throwError("Type error");//throwError("GJ 331 Method overloading is done in method " + methName);
        methParam = "";
        argNum = 0;
        n.f5.accept(this, argu);
        n.f6.accept(this, argu);
